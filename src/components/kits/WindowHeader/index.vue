...
<style lang="scss" scoped>
    .vmo-window-header {
        ...
        background-image: linear-gradient(180deg, #F5F4F5 0%, #F6F6F6 3%, #F6F6F6 100%);
    ...
    .is-active {
        ...
        box-shadow: inset 0 0 0 0 rgba(255, 255, 255, 0.60), inset 0 0 0 0 rgba(0, 0, 0, 0.20);
